...
file_path = "Scripps_Mercy_Hospital_San_Diego.csv"  # Change file extension to CSV
...
hospital_name_value = "Scripps Memorial Hospital Encinitas"
last_updated_on_value = "2024-12-03"
hospital_location_value = "354 SANTA FE DRIVE, ENCINITAS, CA, 92024"
...
output_path = "abfss://bronze@projhealthcaresa.dfs.core.windows.net/Scripps_Mercy_Hospital_San_Diego"
...
parquet_path = "abfss://bronze@projhealthcaresa.dfs.core.windows.net/Scripps_Mercy_Hospital_San_Diego/"
...
# # Get distinct values and their count
# distinct_values_count = df.groupBy("drug_unit_of_measurement").count()

# # Show results
# distinct_values_count.show(100)

# COMMAND ----------

# display(distinct_values_count)
