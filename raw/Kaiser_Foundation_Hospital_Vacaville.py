...
container_name = "raw"
file_path = "Kaiser_Foundation_Hospital_Vacaville.csv"  # Change file extension to CSV
...
df = (df.withColumn("hospital_name", lit("KAISER FOUNDATION HOSPITAL - VACAVILLE"))
        .withColumn("last_updated_on", lit("2025-02-01"))
        .withColumn("hospital_location", lit("1 QUALITY DRIVE, VACAVILLE, CA 95688")))
...
output_path = "abfss://bronze@projhealthcare.dfs.core.windows.net/Kaiser_Foundation_Hospital_Vacaville"
df.write.mode("overwrite").parquet(output_path)


# COMMAND ----------

parquet_path = "abfss://bronze@projhealthcare.dfs.core.windows.net/Kaiser_Foundation_Hospital_Vacaville/"
