...
container_name = "raw"
file_path = "Kaiser_Foundation_Hospital_Oakland.csv"  # Change file extension to CSV
...
df = (df.withColumn("hospital_name", lit("Kaiser Foundation Hospital - Oakland"))
        .withColumn("last_updated_on", lit("2025-02-01"))
        .withColumn("hospital_location", lit("3600 Broadway,Oakland,CA 94611")))
...
output_path = "abfss://bronze@projhealthcare.dfs.core.windows.net/Kaiser_Foundation_Hospital_Oakland"
df.write.mode("overwrite").parquet(output_path)


# COMMAND ----------

parquet_path = "abfss://bronze@projhealthcare.dfs.core.windows.net/Kaiser_Foundation_Hospital_Oakland/"
