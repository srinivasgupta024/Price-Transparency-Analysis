...
file_path = "Sharp_Grossmont_Hospital.csv"  # Change file extension to CSV
...
df_with_meta = df \
    .withColumn("hospital_name", lit("Sharp Grossmont Hospital")) \
    .withColumn("last_updated_on", lit("7/1/2024")) \
    .withColumn("hospital_location", lit("5555 Grossmont Center Drive, La Mesa, CA  91942"))
...
output_path = "abfss://bronze@projhealthcaresa.dfs.core.windows.net/Sharp_Grossmont_Hospital/"
