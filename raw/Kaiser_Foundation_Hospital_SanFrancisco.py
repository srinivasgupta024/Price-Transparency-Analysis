...
container_name = "raw"
file_path = "Kaiser_Foundation_Hospital_SanFrancisco.csv"  # Change file extension to CSV
...
df = (df.withColumn("hospital_name", lit("Kaiser Foundation Hospital - San Francisco"))
        .withColumn("last_updated_on", lit("2025-02-01"))
        .withColumn("hospital_location", lit("2425 Geary Boulevard,San Francisco,CA,94115")))
...
output_path = "abfss://bronze@projhealthcare.dfs.core.windows.net/Kaiser_Foundation_Hospital_SanFrancisco"
df.write.mode("overwrite").parquet(output_path)


# COMMAND ----------

parquet_path = "abfss://bronze@projhealthcare.dfs.core.windows.net/Kaiser_Foundation_Hospital_SanFrancisco/"
