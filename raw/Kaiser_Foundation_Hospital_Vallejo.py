...
file_path = "Kaiser_Foundation_Hospital_Vallejo.csv"  # Change file extension to CSV
...
df = (df.withColumn("hospital_name", lit("KAISER FOUNDATION HOSPITAL & REHAB CENTER - VALLEJO"))
        .withColumn("last_updated_on", lit("2025-02-01"))
        .withColumn("hospital_location", lit("975 SERENO DRIVE, VALLEJO, CA 94589")))
...
output_path = "abfss://bronze@projhealthcaresa.dfs.core.windows.net/Kaiser_Foundation_Hospital_Vallejo"
df.write.mode("overwrite").parquet(output_path)


# COMMAND ----------

# output_path = "abfss://bronze@projhealthsa.dfs.core.windows.net/Kaiser_Foundation_Hospital_Vallejo"
# df.write.mode("overwrite").parquet(output_path)


# COMMAND ----------

parquet_path = "abfss://bronze@projhealthcaresa.dfs.core.windows.net/Kaiser_Foundation_Hospital_Vallejo/"
