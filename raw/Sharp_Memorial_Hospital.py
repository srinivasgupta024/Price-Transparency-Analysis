...
file_path = "Sharp_Memorial_Hospital.csv"  # Change file extension to CSV
...
df_with_meta = df \
    .withColumn("hospital_name", lit("Sharp Memorial Hospital")) \
    .withColumn("last_updated_on", lit("7/1/2024")) \
    .withColumn("hospital_location", lit("7901 Frost Street, San Diego, CA  92123"))
...
output_path = "abfss://bronze@projhealthcaresa.dfs.core.windows.net/Sharp_Memorial_Hospital/"
