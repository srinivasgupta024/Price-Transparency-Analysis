...
container_name = "raw"
file_path = "Kaiser_Foundation_Hospital_SanRafael.csv"  # Change file extension to CSV
...
df = (df.withColumn("hospital_name", lit("Kaiser Foundation Hospital - San Rafael"))
        .withColumn("last_updated_on", lit("2025-02-01"))
        .withColumn("hospital_location", lit("99 Montecillo Road,San Rafael,CA	94903-5114")))
...
output_path = "abfss://bronze@projhealthcare.dfs.core.windows.net/Kaiser_Foundation_Hospital_SanRafael"
df.write.mode("overwrite").parquet(output_path)


# COMMAND ----------

parquet_path = "abfss://bronze@projhealthcare.dfs.core.windows.net/Kaiser_Foundation_Hospital_SanRafael/"
