...
container_name = "raw"
file_path = "Kaiser_Foundation_Hospital_Fremont.csv"  # Change file extension to CSV
...
df = (df.withColumn("hospital_name", lit("Kaiser Foundation Hospital - Fremont"))
        .withColumn("last_updated_on", lit("2025-02-01"))
        .withColumn("hospital_location", lit("39400 Paseo Padre Parkway,Fremont,CA,94538")))
...
output_path = "abfss://bronze@projhealthcare.dfs.core.windows.net/Kaiser_Foundation_Hospital_Fremont"
df.write.mode("overwrite").parquet(output_path)


# COMMAND ----------

parquet_path = "abfss://bronze@projhealthcare.dfs.core.windows.net/Kaiser_Foundation_Hospital_Fremont/"
