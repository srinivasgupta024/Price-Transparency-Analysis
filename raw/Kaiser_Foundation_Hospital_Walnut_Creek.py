...
container_name = "raw"
file_path = "Kaiser_Foundation_Hospital_Walnut_Creek.csv"  # Change file extension to CSV
...
df = (df.withColumn("hospital_name", lit("KAISER FOUNDATION HOSPITAL - WALNUT CREEK"))
        .withColumn("last_updated_on", lit("2025-02-01"))
        .withColumn("hospital_location", lit("1425 SOUTH MAIN STREET, WALNUT CREEK, CA 94596")))
...
output_path = "abfss://bronze@projhealthcare.dfs.core.windows.net/Kaiser_Foundation_Hospital_Walnut_Creek/"
...
parquet_path = "abfss://bronze@projhealthcaresa.dfs.core.windows.net/Kaiser_Foundation_Hospital_Walnut_Creek/"
