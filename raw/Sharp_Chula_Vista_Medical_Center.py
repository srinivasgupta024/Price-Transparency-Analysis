...
file_path = "Sharp_Chula_Vista_Medical_Center.csv"  # Change file extension to CSV
...
df_with_meta = df \
    .withColumn("hospital_name", lit("Sharp Chula Vista Medical Center")) \
    .withColumn("last_updated_on", lit("7/1/2024")) \
    .withColumn("hospital_location", lit("751 Medical Center Court, Chula Vista, CA  91911"))
...
output_path = "abfss://bronze@projhealthcaresa.dfs.core.windows.net/Sharp_Chula_Vista_Medical_Center/"
