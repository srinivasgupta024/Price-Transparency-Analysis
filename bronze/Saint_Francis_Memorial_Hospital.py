...
container_name = "demo"
file_path = "Saint_Francis_Memorial_Hospital"
...
# Add static columns
df_with_meta = df.withColumn("hospital_name", lit("St Francis Medical Center")) \
                         .withColumn("hospital_location", lit("3630 East Imperial Highway Lynwood, CA 90262")) \
                         .withColumn("last_updated_on", lit("12-19-2024")) \
...
output_path = "abfss://silver@projhealthcare.dfs.core.windows.net/Saint_Francis_Memorial_Hospital"
