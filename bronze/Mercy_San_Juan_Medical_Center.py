...
container_name = "demo"
file_path = "Mercy_San_Juan_Medical_Center"
...
# Add static columns
df_with_meta = df.withColumn("hospital_name", lit("Mercy San Juan Medical Center")) \
                         .withColumn("hospital_location", lit("6501 Coyle Avenue, Carmichael, CA 95608")) \
...
output_path = "abfss://silver@projhealthcare.dfs.core.windows.net/Mercy_San_Juan_Medical_Center"
