...
container_name = "demo"
file_path = "Methodist_Hospital_of_Sacramento"
...
# Add static columns
df_with_meta = df.withColumn("hospital_name", lit("Methodist Hospital of Sacramento")) \
                         .withColumn("hospital_location", lit("7500 Hospital Dr., Sacramento, CA 95823")) \
...
output_path = "abfss://silver@projhealthcare.dfs.core.windows.net/Methodist_Hospital_of_Sacramento"
