...
# Add static columns
df_with_meta = df.withColumn("hospital_name", lit("Sequoia_Hospital")) \
                         .withColumn("hospital_location", lit("170 Alameda de las Pulgas, Redwood City, CA 94062")) \
...
output_path = "abfss://silver@projhealthcare.dfs.core.windows.net/Sequoia_Hospital"
