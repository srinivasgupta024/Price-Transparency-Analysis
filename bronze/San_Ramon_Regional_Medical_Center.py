...
container_name = "demo"
file_path = "San_Ramon_Regional_Medical_Center"
...
# Add static columns
df_with_meta = df.withColumn("hospital_name", lit("San Ramon Regional Medical")) \
                         .withColumn("hospital_location", lit("6001 Norris Canyon Rd, San Ramon, CA 94583")) \
                         .withColumn("last_updated_on", lit("01-31-2025")) \
...
output_path = "abfss://silver@projhealthcare.dfs.core.windows.net/San_Ramon_Regional_Medical_Center"
