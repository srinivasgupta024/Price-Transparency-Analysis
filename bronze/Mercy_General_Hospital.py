...
container_name = "demo"
file_path = "Mercy_General_Hospital"
...
# Add static columns
df_with_meta = df.withColumn("hospital_name", lit("Mercy General Hospital")) \
                         .withColumn("hospital_location", lit("4001 J St., Sacramento, CA 95819")) \
...
output_path = "abfss://silver@projhealthcare.dfs.core.windows.net/Mercy_General_Hospital"
