...
container_name = "demo"
file_path = "Mercy_Hospital_of_Folsom"
...
# Add static columns
df_with_meta = df.withColumn("hospital_name", lit("Mercy Hospital of Folsom")) \
                         .withColumn("hospital_location", lit("1650 Creekside Dr, Folsom, CA 95630")) \
...
output_path = "abfss://silver@projhealthcare.dfs.core.windows.net/Mercy_Hospital_of_Folsom"
