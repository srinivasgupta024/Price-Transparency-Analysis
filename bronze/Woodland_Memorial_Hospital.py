...
container_name = "demo"
file_path = "Woodland_Memorial_Hospital"
...
# Add static columns
df_with_meta = df.withColumn("hospital_name", lit("Woodland Memorial Hospital")) \
                         .withColumn("hospital_location", lit("1325 Cottonwood St, Woodland, CA 95695")) \
...
output_path = "abfss://silver@projhealthcare.dfs.core.windows.net/Woodland_Memorial_Hospital"
